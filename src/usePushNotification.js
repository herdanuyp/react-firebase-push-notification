...
export default function usePushNotifications() {
  ...
  /**
   * define a click to send push notification
   */

  const onClickSendNotifiationFCM = async () => {
    setLoading(true);
    setError(false);
    const body = {
      data: {
      ...
      to: process.env.REACT_APP_FIREBASE_MESAGGING_TOKEN
    };
